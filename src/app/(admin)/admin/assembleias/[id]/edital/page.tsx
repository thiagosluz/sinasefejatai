...
export default async function EditalPage(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-200 print:bg-white text-zinc-900 font-sans">
      ...
      {/* Papel (A4 Simulação) */}
      <div className="max-w-[210mm] mx-auto bg-white print:w-full print:max-w-none print:shadow-none shadow-2xl p-[25mm] print:p-0 min-h-[297mm] text-justify leading-relaxed">
        ...
        <div className="space-y-6 text-base">
          <p>
            ...
            a ser realizada no dia <strong>{dataRealizacao}</strong>, no(a) <strong>{assembleia.local}</strong>.
          </p>

          <p>
            A Assembleia instalar-se-á em primeira convocação, com 1/3 (um terço) do número de sindicalizados, às <strong>{formatarHora(assembleia.horario_1a_convocacao)}</strong>, ou, em segunda convocação com qualquer quórum às <strong>{formatarHora(assembleia.horario_2a_convocacao)}</strong>, oportunidade em que {assembleia.pautas?.length === 1 ? 'será apreciado o seguinte ponto de pauta:' : 'serão apreciados os seguintes pontos de pauta:'}
          </p>
          ...
          <div className="mt-12 text-center">
            <p className="mb-8">Jataí - GO, {dataHoje}.</p>
