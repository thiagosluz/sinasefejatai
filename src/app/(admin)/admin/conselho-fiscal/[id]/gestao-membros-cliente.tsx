      ...
      <section className="space-y-4">
        <div>
          ...
          <p className="text-sm text-zinc-500">
            Os cargos que compõem o Conselho Fiscal (Titulares e Suplentes). Edite os nomes conforme necessário.
          </p>
        </div>
      ...
      <section className="space-y-4 pt-6 border-t-2 border-dashed border-zinc-200">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm text-zinc-500">
              Cargos adicionais que não compõem as cadeiras obrigatórias.
            </p>
          </div>
