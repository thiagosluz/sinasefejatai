...
export default async function VisualizarOficioPage(props: { params: Promise<{ id: string }> }) {
  ...
  const verificacao = await getDocumentoVerificacao('oficio', params.id)

  return (
    <DocumentoViewWrapper id={params.id} tipoDocumento="oficio">
      <OficioLayout
        dados={doc.dados}
        numero={doc.numero}
        config={config}
