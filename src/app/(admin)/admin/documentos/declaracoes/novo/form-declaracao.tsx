...
export default function FormDeclaracao({ config }: FormDeclaracaoProps) {
  ...
  return (
    <AdminPageWrapper>
      <AdminPageHeader titulo="Nova Declaração" subtitulo="Preencha os dados à esquerda e confira a visualização à direita.">
        ...
        <div className="bg-white border border-brand-border p-6 shadow-[4px_4px_0px_var(--brand-ink)]">
          ...
          <div className="space-y-4">
            ...
            <button onClick={handleSalvar} disabled={salvando}
              ...
              <Save size={16} /> {salvando ? 'Salvando...' : 'Salvar e Gerar Declaração'}
            </button>
          </div>
        </div>
