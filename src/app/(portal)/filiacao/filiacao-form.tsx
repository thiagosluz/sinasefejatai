      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <fieldset className="border border-brand-border-muted rounded-2xl p-5 bg-zinc-50/50">
          ...
          <div className="space-y-4 mt-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <label htmlFor="cpf" className="block text-sm font-medium text-brand-ink mb-1.5">CPF</label>
                <input
                  id="cpf"
                  {...register('cpf')}
              ...
              <div>
                <label htmlFor="siape" className="block text-sm font-medium text-brand-ink mb-1.5">Matrícula SIAPE <span className="text-brand-tinto">*</span></label>
                <input id="siape" {...register('siape')} disabled={isSubmitting} className={`w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-tinto/30 focus:border-brand-tinto bg-white disabled:opacity-50 ${errors.siape ? 'border-brand-tinto' : 'border-brand-border'}`} />
        ...
        <div className="pt-2">
          ...
          <p className="text-xs text-zinc-400 text-center mt-3">
            Seus dados estão seguros. Após o preenchimento, seus dados serão analisados. Você receberá uma confirmação por e-mail ou WhatsApp.
          </p>
        </div>
      </form>
    </>
