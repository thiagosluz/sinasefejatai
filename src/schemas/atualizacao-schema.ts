...
export const AtualizacaoSchema = z.object({
  ...
  siape: z.string().min(1, 'A matrícula SIAPE é obrigatória.'), // Será bloqueado no form, mas mantemos a validação
  ...
  cpf: z.string().optional(), // Será bloqueado no form, mas mantemos
  ...
  timestamp: z.string().optional() // honeypot
})

export type AtualizacaoFormData = z.infer<typeof AtualizacaoSchema>
